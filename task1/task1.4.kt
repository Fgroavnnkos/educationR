fun main() {
    ...
    for (i in num1.count() - 1 downTo 0) {
        result.add( ( ( num1[i].toString().toInt() + num2[i].toString().toInt() + afterSum.toInt() ) % 10 ).toString())
        afterSum =  (num1[i].toString().toInt() + num2[i].toString().toInt() + afterSum.toInt()) / 10
    }
